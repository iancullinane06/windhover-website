...
function AboutUs() {
  return (
    <div>
      {/* Hero Section */}
      <div className="relative flex items-center justify-center bg-white text-text-light h-[600px] overflow-hidden">
        <div
        ...
        <div className="relative z-10 text-center max-w-3xl">
          <h1 className="text-white text-4xl md:text-5xl font-bold mb-4 shadow-lg">About Us</h1>
          <p className="text-white text-lg md:text-xl shadow-lg">Merging Ecology and AI to Protect Natural Habitats</p>
        </div>
      </div>

      {/* Our Values */}
      <div className="bg-stone-300 text-black py-16 px-8">
        <div className="container mx-auto px-4">
          <h5 className="text-7xl font-semibold mb-4 ml-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-lime-white">
            {[
              {
                icon: <IconWrapper icon={<Compost />} bgColor={'bg-stone-300'} color={'text-lime-500'} />,
                title: 'Sustainability',
                description: 'Protecting the planet through innovation.',
                bgColor: 'bg-stone-500',
              },
              {
                icon: <IconWrapper icon={<Timeline />} bgColor={'bg-green-100'} color={'text-lime-500'} />,
                title: 'Precision',
                description: 'Data-driven solutions for conservation.',
                bgColor: 'bg-green-100',
              },
              {
                icon: <IconWrapper icon={<RocketLaunch />} bgColor={'bg-green-200'} color={'text-lime-500'} />,
                title: 'Innovation',
                description: 'Pioneering AI for ecological challenges.',
                bgColor: 'bg-green-200',
              },
              {
                icon: <IconWrapper icon={<Balance />} bgColor={'bg-green-300'} color={'text-lime-500'} />,
                title: 'Integrity',
      ...
      {/* Our Story */}
      <div className="py-16 bg-stone-300 px-8">
        <div className="container mx-auto">
          <h2 className="text-7xl font-semibold mb-4 text-text-light">
            <IconWrapper icon={<Timeline />} bgColor={'bg-sky-500'} color={'text-stone-100'} /> Our Story
          </h2>
          <p className="text-base mb-8 text-text-dark">
